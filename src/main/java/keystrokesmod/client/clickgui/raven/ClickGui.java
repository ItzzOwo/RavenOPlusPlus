...
public class ClickGui extends GuiScreen {
	...
	public void drawScreen(int x, int y, float p) {
        ...
        this.drawCenteredString(this.fontRendererObj, "o", halfScreenWidth + 1 + w_c, quarterScreenHeight + 25,
        ...
        if (latestVersion.isNewerThan(clientVersion)) {
			...
			FontUtil.normal.drawSmoothString(
		            "Raven O++ v" + clientVersion + " | Config: " + Raven.configManager.getConfig().getName(), 4,
